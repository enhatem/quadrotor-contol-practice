...
%           obj.u(4) = 0.1;
           ...
           obj.u(4) = (obj.kP_psi * obj.psi_err + ...
                       ...
                       obj.kD_psi * (obj.psi_err - obj.psi_err_prev)/obj.dt); % We differentiated the error by dividing by dt but it's not recommended because it's usually unstable with sensor noises and depends on the time step and computational power
           ...
           obj.u(1) = obj.m * obj.g - (obj.kP_zdot * obj.zdot_err + ...
                       ...
                       obj.kD_zdot * (obj.zdot_err - obj.zdot_err_prev)/obj.dt); % We differentiated the error by dividing by dt but it's not recommended because it's usually unstable with sensor noises and depends on the time step and computational power
